...
module.exports = {
  ...
  // Lifecycle for the integrator's startVerticalRealtime()/stopVerticalRealtime():
  // start = bring the live channel up now (also done lazily per-op); stop = tear down.
  start: ensureSubscribed, stop: teardown,
