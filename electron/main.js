...
handle("launch", (a) => engine.launch(a.id, a));
...
handle("forever:create", (a) => engine.createForeverWorld(a));
handle("forever:list", () => engine.listForeverWorlds());
handle("forever:enter", (a) => engine.enterForeverWorld(a));
handle("forever:delete", (a) => engine.deleteForeverWorld(a));
handle("pregen:start", (a) => engine.pregenStart(a));
handle("pregen:stop", () => engine.pregenStop());
handle("pregen:status", () => engine.pregenStatus());
handle("pregen:result", () => engine.pregenResult());
...
handle("curseforge:project", (a) => engine.curseforgeProject(a));
