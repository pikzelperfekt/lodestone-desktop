...
contextBridge.exposeInMainWorld("lodestone", {
  ...
  instances: {
    ...
    screenshots: (instanceId) => call("shots:list", { instanceId }),
    storage: () => call("storage:read"),
    reclaim: (bucket) => call("storage:reclaim", { bucket }),
    browse: (opts) => call("files:list", opts),
    ...
    log: (instanceId) => call("logs:read", { instanceId }),
    loaderBridge: (instanceId) => call("loader:bridge", { instanceId }),
  ...
  worlds: {
    ...
    foreverCreate: (opts) => call("forever:create", opts),
    foreverList: () => call("forever:list"),
    foreverEnter: (instanceId) => call("forever:enter", { instanceId }),
    foreverDelete: (instanceId) => call("forever:delete", { instanceId }),
  ...
  servers: {
    ...
    stats: (id) => call("servers:stats", { id }),
    access: (id) => call("servers:access", { id }),
    accessChange: (opts) => call("servers:accessChange", opts),
    plugins: (id) => call("servers:plugins", { id }),
    pluginToggle: (opts) => call("servers:pluginToggle", opts),
